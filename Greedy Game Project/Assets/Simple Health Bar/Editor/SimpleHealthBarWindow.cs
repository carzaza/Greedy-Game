...
{
    private static string version = "1.0.3f";// ALWAYS UDPATE
    private static int importantChanges = 0;// UPDATE ON IMPORTANT CHANGES
    private static string menuTitle = "Main Menu";

    // LAYOUT STYLES //
    private int sectionSpace = 20;

    private int itemHeaderSpace = 10;
    private int paragraphSpace = 5;
    private GUIStyle sectionHeaderStyle = new GUIStyle();
    private GUIStyle itemHeaderStyle = new GUIStyle();
    private GUIStyle paragraphStyle = new GUIStyle();

    private GUILayoutOption[] buttonSize = new GUILayoutOption[] { GUILayout.Width(200), GUILayout.Height(35) };
    private GUILayoutOption[] docSize = new GUILayoutOption[] { GUILayout.Width(300), GUILayout.Height(330) };
    private GUISkin style;
    private Texture2D scriptReference;
    private Texture2D ujPromo, shbProPromo;
    ...
    private static PageInformation mainMenu = new PageInformation() { pageName = "Main Menu" };
    private static PageInformation howTo = new PageInformation() { pageName = "How To" };
    private static PageInformation overview = new PageInformation() { pageName = "Overview" };
    private static PageInformation documentation = new PageInformation() { pageName = "Documentation" };
    private static PageInformation otherProducts = new PageInformation() { pageName = "Other Products" };
    private static PageInformation feedback = new PageInformation() { pageName = "Feedback" };
    private static PageInformation changeLog = new PageInformation() { pageName = "Change Log" };
    private static PageInformation versionChanges = new PageInformation() { pageName = "Version Changes" };
    private static PageInformation thankYou = new PageInformation() { pageName = "Thank You" };
    private static PageInformation settings = new PageInformation() { pageName = "Window Settings" };
    private static List<PageInformation> pageHistory = new List<PageInformation>();
    private static PageInformation currentPage = new PageInformation();
    ...
    private bool configuredFontSize = false;

    private static Texture2D introThumbnail;
    private static UnityWebRequest introThumbnailPage;
    ...
    private DocumentationInfo p_UpdateBar = new DocumentationInfo()
    {
    ...
    private DocumentationInfo p_UpdateColor = new DocumentationInfo()
    {
    ...
    private DocumentationInfo p_UpdateTextColor = new DocumentationInfo()
    {
    ...
    #endregion Simple Health Bar Documentation
    ...
    private static void NavigateForward(PageInformation menu)
    {
    ...
    private void DocumentationPage()
    {
    ...
    private void StartPage(PageInformation pageInfo)
    {
    ...
    [InitializeOnLoad]
    private class SimpleHealthBarInitialLoad
    {
        static SimpleHealthBarInitialLoad()
        {
            ...
            if (!EditorPrefs.HasKey("SimpleHealthBarFreeVersion"))
            {
                ...
                introThumbnailPage = UnityWebRequestTexture.GetTexture("https://www.tankandhealerstudio.com/uploads/7/7/4/9/77490188/shb-free-intro-thumb-small_orig.png");
        ...
        private static void WaitForIntroThumbnail()
        {
            ...
            introThumbnail = DownloadHandlerTexture.GetContent(introThumbnailPage);
        }
    }
}